...
window.onload = function()
{
	...
	for(var i = 0; i <= 9; i++)
	{
		...
		if(i >= 1 && i <= 4)
		{
			...
			{//Tiene que existir un número antes | No pueden existir dos operadores seguidos | No puede quedar un operador al final...
				if(operacion.length != 0 && operacion.indexOf(operaciones.operador) != null && operacion.length-1 != operaciones.operador)
				{					
